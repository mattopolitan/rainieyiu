...
class SHIPANY_API_Auth_REST {
	...
	protected function request_access_token( $client_id, $client_secret ) {
		...
		if( empty( $this->client_id ) || empty( $this->client_secret ) ) {
			throw new Exception( __('The "Cliend Id" or "Client Secret" is empty.','pr-shipping-shipany' ) );
		}
		...
		switch ( $response_code ) {
			...
			case '401':
			default:
				throw new Exception( __( 'Authentication failed: Please check API Token in the shipping settings', 'pr-shipping-shipany' ) );
				break;
		}		
	}
